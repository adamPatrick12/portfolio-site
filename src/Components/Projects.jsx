      ...
      <div className="projectsContainer">
        ...
        <div className="Project">
          <div className="ProjectTextContainer">
            ...
            <div className="ProjectDesc">
              An app that provides various NFT data like the market cap, number
              of owners, 7-day trading volume, and the floor price for various
              NFT collections. Built with React, Framer Motion and the Opensea
              API
            </div>
            <div className="ProjectButton">
              <button
              ...
              <button
                onClick={() =>
                  window.open(
                    "https://github.com/adamPatrick12/nft-shop",
                    "_blank"
                  )
                }
                className="CodeBTN"
